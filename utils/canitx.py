class CaniTX:
    ...
    def power_up(self, ch_lbl:int=16, cat_lbl:int=16, title_lbl:int=36, loss_exp:bool=True) -> bytes:
        ...
        """
        print("Powering up")
        return self.parent.pcr_tx(bytes([0x00, ch_lbl, cat_lbl, title_lbl, loss_exp]))
    ...
    def power_down(self, pwr_sav:bool=False) -> bytes:
        ...
        """
        print("Powering down")
        return self.parent.pcr_tx(bytes([0x01, pwr_sav]))
    ...
    def set_linevol(self, db:int) -> bytes:
        ...
        return self.parent.pcr_tx(bytes([0x0B, db]))
    ...
    def change_channel(self, channel:int, is_sid:bool=False, data:bool=False, prg_type:int=0) -> bytes:
        ...
        return self.parent.pcr_tx(bytes([0x10, 0x02 - is_sid, channel, data, prg_type, 0x01 + data]))
    ...
    def channel_cancel(self, channel:int=0, data:bool=False) -> bytes:
        ...
        return self.parent.pcr_tx(bytes([0x11, channel, data]))
    ...
    def set_mute(self, mute:bool) -> bytes:
        ...
        return self.parent.pcr_tx(bytes([0x13, mute]))
    ...
    def ext_info(self, channel:int) -> bytes:
        ...
        return self.parent.pcr_tx(bytes([0x22, channel]))
    ...
    def channel_info(self, channel:int, is_sid:bool=False, prg_type:int=0) -> bytes:
        ...
        return self.parent.pcr_tx(bytes([0x25, 0x08 - is_sid, channel, prg_type]))
    ...
    def get_radioid(self) -> bytes:
        ...
        return self.parent.pcr_tx(bytes([0x31]))
    ...
    def signal_mon(self, toggle:bool) -> bytes:
        ...
        return self.parent.pcr_tx(bytes([0x42, toggle]))
    ...
    def signal_info(self) -> bytes:
        ...
        return self.parent.pcr_tx(bytes([0x43]))
    ...
    def clock_mon(self, toggle:bool) -> bytes:
        ...
        return self.parent.pcr_tx(bytes([0x4E, toggle]))
    ...
    def chan_mon(self, channel:int, is_data_on:bool=False, serv_mon:bool=True, prgtype_mon:bool=True, inf_mon:bool=True, ext_mon:bool=True) -> bytes:
        ...
        return self.parent.pcr_tx(bytes([0x50 - is_data_on, channel, serv_mon, prgtype_mon, inf_mon, ext_mon]))
    ...
    def diag_mon(self, toggle:bool) -> bytes:
        ...
        return self.parent.pcr_tx(bytes([0x60, toggle]))
    ...
    def firm_ver(self, magic:int=5) -> bytes:
        ...
        return self.parent.pcr_tx(bytes([0x70, magic]))
